<%@page import="com.java.bank.model.AccountModel"%>
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<div class="col-md-4">
					<div class="well">
						...
						<p>Deposit mobilization is an integral part of banking activity. Mobilization of savings through intensive deposit collection has been regarded as the major task of banking in India. Acceptance of deposits is the primary function of commercial banks</p>
						<hr>
